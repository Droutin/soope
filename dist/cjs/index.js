...
class Core {
    ...
    async initRoutes() {
        ...
        for (const filePath of filePaths) {
            const { default: Route } = await Promise.resolve().then(() => __importStar(require(filePath)));
    ...
    async importMiddlewares() {
        ...
        for (const filePath of filePaths) {
            const { default: Middleware } = await Promise.resolve().then(() => __importStar(require(filePath)));
